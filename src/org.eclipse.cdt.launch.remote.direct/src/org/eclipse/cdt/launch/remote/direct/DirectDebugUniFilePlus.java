...
public class DirectDebugUniFilePlus extends File {
	/**
	 *
	 */
	 ...
	 */
	public DirectDebugUniFilePlus(IRemoteFile remoteFile) {
	...
	public int compareTo(File pathname) {
		if (pathname instanceof DirectDebugUniFilePlus) 
...
/*
	...
	public boolean equals(Object obj) {
		if (obj instanceof DirectDebugUniFilePlus){
			DirectDebugUniFilePlus uniF = (DirectDebugUniFilePlus)obj;
	...
	public File[] listFiles() {
		...
		if (files != null) {
			Vector<DirectDebugUniFilePlus> children = new Vector<DirectDebugUniFilePlus>();
			for (int i = 0; i < files.length; i++) {
				// fileName = files[idx].getName();
				DirectDebugUniFilePlus fileObj = new DirectDebugUniFilePlus(files[i]);
				children.addElement(fileObj);
			}
			DirectDebugUniFilePlus[] fileObjs = new DirectDebugUniFilePlus[children.size()];
